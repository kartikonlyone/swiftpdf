...
export const authOptions = {
  ...
  // Fallback secret added so Vercel build phase never crashes if env is missing
  secret: process.env.NEXTAUTH_SECRET || "fallback_secret_key_for_build_environment_12345"
};
